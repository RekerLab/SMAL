#!/usr/bin/env bash
# Active learning on MDR1_MDCK_classification2 with RandomForest/Morgan.
#
# Reproduces results-initial/active_learning/al-MDR1_MDCK_classification2-*
...
for ERR in 0 10 20 30 40; do
  ...
  for SEED in $(seq 0 19); do
    SAVE_DIR="${OUT_ROOT}/al-MDR1_MDCK_classification2-${ERR}-${SEED}"
    rm -rf "${SAVE_DIR}"
    molalkit_run \
