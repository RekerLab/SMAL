#!/usr/bin/env bash
# Passive learning on PAMPA_NCATS with RandomForest/Morgan.
#
# Reproduces results-initial/passive_learning/pl-PAMPA_NCATS-*
...
for ERR in 0 10 20 30 40; do
  ...
  for SEED in $(seq 0 19); do
    SAVE_DIR="${OUT_ROOT}/pl-PAMPA_NCATS-${ERR}-${SEED}"
    rm -rf "${SAVE_DIR}"
    molalkit_run \
